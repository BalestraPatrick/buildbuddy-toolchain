...
windows_cc_toolchain_config(
    ...
    msvc_env_path = ";".join([
        ...
        "C:\\BuildTools\\Common7\\IDE\\VC\\Linux\\bin\\ConnectionManagerExe",
        "C:\\BuildTools\\Common7\\IDE\\VC\\VCPackages",
        "C:\\BuildTools\\Common7\\Tools\\",
        "C:\\BuildTools\\MSBuild\\Current\\bin\\Roslyn",
        "C:\\BuildTools\\Team Tools\\DiagnosticsHub\\Collector",
        "C:\\BuildTools\\VC\\Tools\\MSVC\\%{msvc_version}\\bin\\HostX64\\x64",
    ...
    msvc_env_lib = ";".join([
        ...
        "C:\\BuildTools\\VC\\Tools\\MSVC\\%{msvc_version}\\lib\\x64",
    ]),
    msvc_cl_path = "C:/BuildTools/VC/Tools/MSVC/%{msvc_version}/bin/HostX64/x64/cl.exe",
    msvc_ml_path = "C:/BuildTools/VC/Tools/MSVC/%{msvc_version}/bin/HostX64/x64/ml64.exe",
    msvc_link_path = "C:/BuildTools/VC/Tools/MSVC/%{msvc_version}/bin/HostX64/x64/link.exe",
    msvc_lib_path = "C:/BuildTools/VC/Tools/MSVC/%{msvc_version}/bin/HostX64/x64/lib.exe",
    cxx_builtin_include_directories = [
        "C:\\Program Files (x86)\\Windows Kits\\%{windows_kits_release}\\Include\\%{windows_kits_version}\\cppwinrt",
        "C:\\Program Files (x86)\\Windows Kits\\%{windows_kits_release}\\Include\\%{windows_kits_version}\\shared",
        "C:\\Program Files (x86)\\Windows Kits\\%{windows_kits_release}\\Include\\%{windows_kits_version}\\um",
    ...
    tool_paths = {
        ...
        "ml": "C:/BuildTools/VC/Tools/MSVC/%{msvc_version}/bin/HostX64/x64/ml64.exe",
        "cpp": "C:/BuildTools/VC/Tools/MSVC/%{msvc_version}/bin/HostX64/x64/cl.exe",
        "gcc": "C:/BuildTools/VC/Tools/MSVC/%{msvc_version}/bin/HostX64/x64/cl.exe",
        "gcov": "wrapper/bin/msvc_nop.bat",
        "ld": "C:/BuildTools/VC/Tools/MSVC/%{msvc_version}/bin/HostX64/x64/link.exe",
